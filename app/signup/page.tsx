...
import { Eye, EyeOff, TrendingUp, Mail, Lock, User, Phone } from "lucide-react"
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-card relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-20">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-md">
            Join thousands of traders who are automating their strategies and maximizing returns with MyAlgo.
          </p>
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="bg-background/50 backdrop-blur-sm rounded-xl p-4 border border-border">
              <p className="text-3xl font-bold text-primary mb-1">₹100Cr+</p>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="space-y-3 mb-6">
            <Button
              variant="outline"
              className="w-full h-12 bg-card border-border hover:bg-muted hover:border-muted-foreground/30 text-foreground"
            >
          ...
          <form className="space-y-4">
            ...
            <div className="flex items-start gap-2">
              <input
                type="checkbox"
                id="terms"
                className="w-4 h-4 mt-0.5 rounded border-border bg-card text-primary focus:ring-primary focus:ring-offset-background"
              />
          ...
          <p className="mt-6 text-center text-xs text-muted-foreground">
            By creating an account, you acknowledge that trading involves risk and you may lose money.
          </p>
        </div>
      </div>
    </div>
